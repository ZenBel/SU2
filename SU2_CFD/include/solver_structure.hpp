...
//	virtual void SetSecondary_Limiter(CGeometry *geometry, CConfig *config);
   ...
   * \param[in] visc_numerics - Description of the numerical method.
	 ...
	 * \param[in] val_marker - Surface marker where the boundary condition is applied.
	 */
	virtual void BC_NonUniform(CGeometry *geometry, CSolver **solver_container,
                            CNumerics *conv_numerics, CNumerics *visc_numerics, CConfig *config, unsigned short val_marker);
   ...
   * \param[in] visc_numerics - Description of the numerical method.
	 ...
	 * \param[in] val_marker - Surface marker where the boundary condition is applied.
	 */
	virtual void BC_TurboNonUniform(CGeometry *geometry, CSolver **solver_container,
                            CNumerics *conv_numerics, CNumerics *visc_numerics, CConfig *config, unsigned short val_marker);
	/*!
	 * \brief A virtual member.
	 * \param[in] geometry - Geometrical definition of the problem.
...
//	void SetSecondary_Limiter(CGeometry *geometry, CConfig *config);
   ...
   * \param[in] visc_numerics - Description of the numerical method.
	 ...
	 * \param[in] val_marker - Surface marker where the boundary condition is applied.
	 */
	void BC_TurboNonUniform(CGeometry *geometry, CSolver **solver_container,
                            CNumerics *conv_numerics, CNumerics *visc_numerics, CConfig *config, unsigned short val_marker);
...
public:
  ...
  /*!
	...
	/*!
	 * \brief Impose the boundary condition to the non-uniform boundary.
	 * \param[in] geometry - Geometrical definition of the problem.
	 * \param[in] solver_container - Container vector with all the solutions.
	 * \param[in] conv_numerics - Description of the numerical method.
	 * \param[in] visc_numerics - Description of the numerical method.
