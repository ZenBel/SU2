...
protected:
  ...
  *Residual_Sum;    /*!< \brief Auxiliar structure for residual smoothing. */
  ...
  SensNUBC_Pstatic,					/*!<brief pressure sensitivity for the NUBC*/
...
public:
  ...
  void SetTtot_nubc(su2double val_ttot_nubc);
  su2double GetTtot_nubc(void);

  void SetAlpha_nubc(su2double val_alpha);
  su2double GetAlpha_nubc(void);

  void SetPstatic_nubc(su2double val_pressure);
  su2double GetPstatic_nubc(void);
