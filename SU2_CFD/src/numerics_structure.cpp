...
void CNumerics::GetViscousProjFlux(su2double *val_primvar,
  ...
  SetReynoldsStressMatrix(val_turb_ke, val_primvar, val_gradprimvar, val_eddy_viscosity);
  SetPerturbedRSM(val_turb_ke, config, Global_Index);
...
//			            - TWO3*Density*val_turb_ke*delta[iDim][jDim];
    	...
    	tau_turb[iDim][jDim] = - Density * MeanReynoldsStress[iDim][jDim] * (1.0 - blend)
    				           - Density * MeanPerturbedRSM[iDim][jDim] * blend;
...
//  for (iDim = 0 ; iDim < nDim; iDim++){
//    for (jDim = 0 ; jDim < nDim; jDim++){
//    	cout << "rst[" << iDim << "][" << jDim << "] = " << - Density * MeanReynoldsStress[iDim][jDim] << endl;
//    }
//  }
//
//  /* --- Calculate Eigen decomposition of anisotropic part of RST for debugging purposes --- */
//
//  su2double **AA_ij = new su2double* [3];
//  su2double **EEig_Vec = new su2double* [3];
//  su2double *EEig_Val = new su2double [3];
//  for (iDim = 0; iDim < 3; iDim++){
//    AA_ij[iDim] = new su2double [3];
//    EEig_Vec[iDim] = new su2double [3];
//  }
//
//  for (iDim = 0; iDim< 3; iDim++){
//    for (jDim = 0; jDim < 3; jDim++){
//      AA_ij[iDim][jDim] = .5 * MeanReynoldsStress[iDim][jDim] / val_turb_ke - delta3[iDim][jDim] / 3.0;
//      EEig_Vec[iDim][jDim] = AA_ij[iDim][jDim];
//    }
//  }
//
//  /* --- Get ordered eigenvectors and eigenvalues of A_ij --- */
//  /* Note: the Eigendecomposition routing returns the eigvals sorted
//   * from the smallest tot he largest (and accordingly for the eigenvector order).
//   */
//
//  EigenDecomposition(AA_ij, EEig_Vec, EEig_Val, 3);
//
//  cout << "eig_val0 = " << EEig_Val[2] << endl;
//  cout << "eig_val1 = " << EEig_Val[1] << endl;
//  cout << "eig_val2 = " << EEig_Val[0] << endl;
//
//  cout << "eig_vec00 = " << EEig_Vec[0][2] << endl;
//  cout << "eig_vec01 = " << EEig_Vec[0][1] << endl;
//  cout << "eig_vec02 = " << EEig_Vec[0][0] << endl;
//  cout << "eig_vec10 = " << EEig_Vec[1][2] << endl;
//  cout << "eig_vec11 = " << EEig_Vec[1][1] << endl;
//  cout << "eig_vec12 = " << EEig_Vec[1][0] << endl;
//  cout << "eig_vec20 = " << EEig_Vec[2][2] << endl;
//  cout << "eig_vec21 = " << EEig_Vec[2][1] << endl;
//  cout << "eig_vec22 = " << EEig_Vec[2][0] << endl;
//
//  for (iDim = 0; iDim < 3; iDim++){
//    delete [] AA_ij[iDim];
//    delete [] EEig_Vec[iDim];
//  }
//  delete [] AA_ij;
//  delete [] EEig_Vec;
//  delete [] EEig_Val;
...
void CNumerics::GetMeanRateOfStrainMatrix(su2double **S_ij, su2double **Mean_GradPrimVar){
...
void CNumerics::SetReynoldsStressMatrix(su2double turb_ke, su2double *Mean_PrimVar, su2double **Mean_GradPrimVar,
  ...
  GetMeanRateOfStrainMatrix(S_ij, Mean_GradPrimVar);
