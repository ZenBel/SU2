...
su2double CConfig::GetNUBC_d2Var1(unsigned long val_pos) {
  return NonUniform_d2Var1[val_pos];
}

su2double CConfig::GetNUBC_d2Var2(unsigned long val_pos) {
  return NonUniform_d2Var2[val_pos];
}

su2double CConfig::GetNUBC_d2Var3(unsigned long val_pos) {
  return NonUniform_d2Var3[val_pos];
}

su2double CConfig::GetNUBC_d2Var4(unsigned long val_pos) {
  return NonUniform_d2FlowDir_x[val_pos];
}

su2double CConfig::GetNUBC_d2Var5(unsigned long val_pos) {
  return NonUniform_d2FlowDir_y[val_pos];
}

su2double CConfig::GetNUBC_d2Var6(unsigned long val_pos) {
  return NonUniform_d2FlowDir_z[val_pos];
}
